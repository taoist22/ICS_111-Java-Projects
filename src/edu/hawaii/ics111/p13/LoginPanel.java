 ...
 * Extra Credit: Implemented feature to disable login button until after text is entered in 
...
public class LoginPanel extends JPanel
{
	...
	/**
	 * Constructor LoginPanel, initializes the layout and adds components to the layout.
	 */
  public LoginPanel()
  {
	  super();
  ...
  /**
   * Implement Document Listener to determine if user has entered something in username 
   * and password fields.
   */
