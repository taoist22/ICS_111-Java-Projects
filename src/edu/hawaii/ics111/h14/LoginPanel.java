...
{
  private final List<LoginCredentials> validCredentials;
  /**
   ...
   * layout.
   * @param validCredentials List of valid login credentials.
   * @throws IllegalArgumentException If validCredentials is null.
   */
  public LoginPanel(List<LoginCredentials> validCredentials)
  {
    super();

    if (validCredentials == null)
    {
      throw new IllegalArgumentException("Valid credentials list cannot be null");
    }
    ...
    loginButton.addActionListener(new ActionListener()
    {
      ...
      public void actionPerformed(ActionEvent e)
      {
        ...
        try
        {
          LoginCredentials enteredCredentials = new LoginCredentials(enteredUser, enteredPass);

          if (validCredentials.contains(enteredCredentials))
          {
