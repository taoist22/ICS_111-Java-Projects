package edu.hawaii.ics111.p10;

/**
 * A Java example of a Cat class with name, breed, age and hunger status.
 * Includes examples of constructors, getters, setters and increments age method.
 *
...
class Cat
{
  ...
  /**
   * Construction of cat object always hungry status and includes name, breed, and age.
   *
   * @param name   the name of the cat.
   * @param breed  the breed of the cat.
   * @param age    the age of the cat.
